...
import { Send, Bot, User, Loader2, Heart, Brain, Stethoscope, Upload, Zap, Sparkles } from "lucide-react"
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col">
        ...
        <TabsContent value="chat" className="flex-1 flex flex-col mt-0">
          ...
          <div className="flex gap-2 mb-4 flex-wrap">
            <Badge
              variant="secondary"
              className="cursor-pointer hover:bg-medical-blue/10 transition-all duration-300 badge-hover"
            ...
            <Badge
              variant="secondary"
              className="cursor-pointer hover:bg-medical-green/10 transition-all duration-300 badge-hover"
            ...
            <Badge
              variant="secondary"
              className="cursor-pointer hover:bg-medical-purple/10 transition-all duration-300 badge-hover"
                  ...
                  >
                    {message.type !== "user" && (
                      <Avatar className="h-8 w-8 mt-1 hover-lift">
                        <AvatarFallback
                          className={`
                          ${message.type === "assistant" ? "bg-gradient-to-br from-medical-blue/20 to-medical-purple/20 text-medical-blue" : "bg-medical-gray/10 text-muted-foreground"}
                    ...
                    <div
                      ...
                      ${message.isTyping ? "animate-pulse-glow" : ""}
                    `}
                    >
                      {message.isTyping ? (
                        <div className="flex items-center gap-2">
                          <Loader2 className="h-4 w-4 animate-spin text-medical-blue" />
                          <span className="text-medical-blue">{message.content}</span>
            ...
            <div className="border-t p-4 bg-gradient-to-r from-medical-blue/5 to-transparent">
              <div className="flex gap-2">
                <Input
                  ...
                  disabled={isLoading}
                  className="flex-1 focus:ring-medical-blue/50 input-focus border-medical-blue/20 transition-all duration-300"
                />
                <Button
...
// Shield icon component (simple implementation)
